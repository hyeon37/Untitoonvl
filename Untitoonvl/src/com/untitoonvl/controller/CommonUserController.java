...
/**
 * Servlet implementation class CommonUserController
 */
@WebServlet("*.cmn")
public class CommonUserController extends HttpServlet {
	...
	private HashMap<String, Object> cmnMap = new HashMap<>();
 ...
 // doGet, doPost와 달리 한번만 실행됨
	...
	private void loadProperties() {
   		ResourceBundle bundle = ResourceBundle.getBundle("com/untitoonvl/properties/CmnCommand");
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		if (userVo == null) { // 로그인되지 않았다면
			...
			IAction action = (IAction)cmnMap.get(command);
